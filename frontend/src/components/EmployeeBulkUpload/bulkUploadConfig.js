...
export const BULK_UPLOAD_COLUMNS = [
  ...
  { key: 'full_name', label: 'Name Of Employees', required: true, aliases: ['name', 'employee name', 'employee_name', 'name of employee', 'name_of_employees'] },
  { key: 'first_name', label: 'First Name', required: false, aliases: ['first name', 'firstname'] },
  { key: 'last_name', label: 'Last Name', required: false, aliases: ['last name', 'lastname'] },
  ...
  { key: 'salary', label: 'CTC', required: true, aliases: ['annual salary', 'annual ctc', 'ctc'] },
  { key: 'salary_basic', label: 'Basic', required: true, aliases: ['basic', 'basic salary', 'salary_basic'] },
  ...
  { key: 'salary_other_allowance', label: 'Other', required: false, aliases: ['other', 'other allowance', 'other_allowance', 'special allowance', 'special', 'salary_other_allowance'] },
  ...
  { key: 'is_active', label: 'Is Active', required: false, aliases: ['active', 'status'] }
];
